...
const DailyActivityCard = ({
  data: {distance, burnedCalories, stepCount, walkingTime},
  targetStepCount,
  optionButtonHandler,
}: Props) => {
  return (
    <View style={styles.container}>
      ...
      <Spacer size={18} />
      <ProgressBar total={targetStepCount} now={stepCount} />
      <Spacer size={24} />
      <ActivityView
        data={{calorie: burnedCalories, time: walkingTime, distance: distance}}
        iconColor={'#FB970C'}
        textColor={'#423D36'}
      />
    </View>
