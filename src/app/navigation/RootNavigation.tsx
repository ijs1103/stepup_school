...
const MainTabs = () => (
  <Tab.Navigator tabBar={({ state, navigation }) => <CustomTabBar state={state} navigation={navigation} />} screenOptions={{ headerShown: false }}>
...
export const useRootStackNavigation = <RouteName extends keyof RootStackParams>() =>
