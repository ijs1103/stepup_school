...
import WeeklyChart, {
  ChartCategory,
  DailyWalkingStats,
} from '@/shared/ui/WeeklyChart/WeeklyChart';
...
const WeeklyRecordScreen = () => {
  ...
  const {activityStats, stepCountData, errorMessage, refetch} =
    useActivityStats({
  ...
  return (
    <ScrollView
      ...
      <GradientBackgroundView colors={['#FB970C', '#F8F7F7']}>
        <NavBar title={'주간 통계'} backButtonIcon={'ArrowBackWhite'} />
        <Spacer size={48} />
        <View style={styles.activityContainer}>
          ...
          <View style={styles.activityViewContainer}>
            <ActivityView
              data={{
                calorie: activityStats.burnedCalories,
                time: activityStats.walkingTime,
