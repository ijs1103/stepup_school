    ...
    <View style={styles.container}>
      <View style={styles.subcontainer}>
        ...
        <View>
          ...
          <Spacer size={3} />
          <CustomButton title={'이메일로 로그인하기'} textColor={'#FDB44F'} backgroundColor={'#fff'} borderColor={'#FDB44F'} clickHandler={signinHandler} />
          <Spacer size={13} />
          <Text style={styles.label}>{'아래 버튼을 눌러 시작해 보세요!'}</Text>
          <Spacer size={3} />
          <CustomButton title={'스텝업 스쿨 시작하기'} textColor={'#fff'} backgroundColor={'#FB970C'} clickHandler={signupHandler} />
        </View>
      </View>
    </View>
  );
