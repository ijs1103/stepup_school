...
const PersonalInfoChangeScreen = () => {
    ...
    return (
        <View style={styles.container}>
            <NavBar title={'개인정보 설정'} titleColor={'#423836'} backButtonIcon={'ArrowBackGray'} />
            <View style={styles.subcontainer}>
                <View style={styles.formContainer}>
                    ...
                    <Controller
                        ...
                        name={'nickname'} />
                    {errors.nickname?.message && <Text style={styles.errorMessage}>{errors.nickname?.message}</Text>}
                    <Spacer size={34} />
                    <TouchableOpacity onPress={navigateToPersonalInfoChange} style={styles.bodyInfoChangeButton}>
                        <Text>{'신체 정보 수정'}</Text>
                    </TouchableOpacity>
                </View>
