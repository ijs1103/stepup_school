...
const SignUpScreen = () => {
    ...
    const onValid = useCallback(({ NAME, NICKNAME, EMAIL, PASSWORD }: IForm) => {
        setAuthInfo({ name: NAME, nickname: NICKNAME, email: EMAIL, password: PASSWORD });
            ...
            <View style={styles.container}>
                <View>
                    ...
                    <View style={styles.formContainer}>
                        ...
                        />
                        <Spacer size={40} />
                        <SignupLabel title={'메일 주소를 입력해 주세요'} subTitle={'⚠ 아이디, 비밀번호 변경으로 사용되어요'} />
                        <Spacer size={16} />
                        <FormInput
                            name={'EMAIL'}
                            textInputConf={{
