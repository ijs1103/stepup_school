...
import AccountOptionItem, {
  AccountOptionItemProps,
} from '@/features/setting/ui/AccountOptionItem';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.accountOptionList}>
        {accountOptionListData.map(item => (
          <AccountOptionItem key={item.title} {...item} />
        ))}
      </View>
    </View>
  );
